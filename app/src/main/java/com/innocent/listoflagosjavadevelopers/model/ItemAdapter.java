package com.innocent.listoflagosjavadevelopers.model;
...
import com.innocent.listoflagosjavadevelopers.R;
import com.innocent.listoflagosjavadevelopers.controller.DetailActivity;
...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder> {
    ...
    public ItemAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activity_row_list, viewGroup, false);
